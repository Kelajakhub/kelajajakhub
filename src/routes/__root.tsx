...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Yosh ixtirochilar g'oyalarini raqamli muhrlaydi va patent olish uchun vazirlikka yo'naltiradi.",
      },
      { name: "author", content: "KelajakHub" },
      { property: "og:title", content: "KelajakHub" },
      { property: "og:description", content: "G'oyangizni rasmiy patent darajasiga olib chiqing." },
